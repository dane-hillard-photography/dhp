...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photograph.album'
        db.add_column(u'photography_photograph', 'album',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photography.Album'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Photograph.album'
        db.delete_column(u'photography_photograph', 'album_id')
    ...
    models = {
        ...
        u'photography.album': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c622d48a-e8f7-4b0f-97d8-fcc52b24a808'", 'unique': 'True', 'max_length': '36'})
        },
        u'photography.photograph': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'788e7b54-6aa6-4eed-a757-c7f35273af87'", 'unique': 'True', 'max_length': '36'}),
