...
ADMINS = (("Dane Hillard", "github@danehillard.com"),)
...
LOGGERS.update({app: {"level": LOG_LEVEL, "handlers": ["console"], "propagate": False,} for app in MY_APPS})
...
WHITELISTED_CRAWLERS = {
    ...
    "twitter": ["Twitterbot", "Twitterbot/1.0",],
