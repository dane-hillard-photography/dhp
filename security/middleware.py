CONTENT_SECURITY_POLICY = {
    'default-src': "'self'",
    'script-src': "'self' connect.facebook.net assets.pinterest.com danehillard.disqus.com danehillard-dev.disqus.com log.pinterest.com www.google-analytics.com 'unsafe-inline'",
